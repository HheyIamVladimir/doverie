...
function loadDB() {
    ...
    return { users: [], messages: [], groups: [], groupMessages: [], channels: [], channelPosts: [], channelComments: [], reports: [], feed: [], lastId: 1000, lastGroupId: 100, lastChannelId: 0, lastFeedId: 0 };
}
...
app.post('/api/call/end', (req, res) => {
    ...
    // Удаляем все звонки с этим channelName
