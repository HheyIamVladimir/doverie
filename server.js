...
let db = { users: [], messages: [], groups: [], groupMessages: [], channels: [], channelPosts: [], channelComments: [], reports: [], feed: [], lastId: 1000, lastGroupId: 100, lastChannelId: 0, lastFeedId: 0 };
...
function loadDB() {
    ...
    return { users: [], messages: [], groups: [], groupMessages: [], channels: [], channelPosts: [], channelComments: [], reports: [], feed: [], callHistory: [], lastId: 1000, lastGroupId: 100, lastChannelId: 0, lastFeedId: 0 };
}
...
app.get('/api/chats/:myId', (req, res) => {
    ...
    const activeChats = db.users
        .filter(u => chattedIds.has(u.id) && !u.hidden)
        .map(u => {
